...
How many total route combinations are available for the farmerâ€™s journey?

## Solution

### Part 1: Movement Through Checkpoints
- Checkpoint 1:Â 1Â route (1 closed, 1 open).
- Checkpoint 2:Â 3Â routes.
- Checkpoint 3:Â 1Â route (1 blocked).
FCP:Â $1 \times 3 \times 1=3$ different route combinations
